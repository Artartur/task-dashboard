...
export default function Dashboard() {
  ...
  const sortTasksByDate = (tasks: ITask[], sortOrder: string) => {
          ...
          <div className="row gap-4">
            ...
            >
              <div className="col border-b border-gray-400 pb-4">
                <h3 className="border-b border-gray-400 pb-1">
                  Pending
                </h3>
                  ...
                  <div className="col *:space-y-1">
                    ...
                    <div className="col">
                      ...
                      <select
                        ...
                        name="date"
                        value={sortFilters.PENDING}
                        onChange={(e) => setSortFilters({ ...sortFilters, PENDING: e.target.value })}
                      >
                  ...
                  <div className="col *:space-y-1">
                    ...
                    <div className="col">
                      ...
                      <select
                        className="border border-gray-300 rounded-sm p-1 w-full outline-0 text-gray-300 *:text-black"
                        name="date"
                        value={sortFilters.IN_PROGRESS}
                        onChange={(e) => setSortFilters({ ...sortFilters, IN_PROGRESS: e.target.value })}
                      >
                        <option value="">No date filter</option>
                        <option value="newest">Newest first</option>
                        <option value="oldest">Oldest first</option>
                  ...
                  <div className="col *:space-y-1">
                    ...
                    <div className="col">
                      ...
                      <select
                        className="border border-gray-300 rounded-sm p-1 w-full outline-0 text-gray-300 *:text-black"
                        name="date"
                        value={sortFilters.COMPLETED}
                        onChange={(e) => setSortFilters({ ...sortFilters, COMPLETED: e.target.value })}
                      >
                        <option value="">No date filter</option>
                        <option value="newest">Newest first</option>
                        <option value="oldest">Oldest first</option>
                  ...
                  <div className="col *:space-y-1">
                    ...
                    <div className="col">
                      ...
                      <select
                        className="border border-gray-300 rounded-sm p-1 w-full outline-0 text-gray-300 *:text-black"
                        name="date"
                        value={sortFilters.CANCELED}
                        onChange={(e) => setSortFilters({ ...sortFilters, CANCELED: e.target.value })}
                      >
                        <option value="">No date filter</option>
                        <option value="newest">Newest first</option>
                        <option value="oldest">Oldest first</option>
